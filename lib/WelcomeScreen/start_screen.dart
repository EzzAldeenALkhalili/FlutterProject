...
import 'package:fluuter_test/registration_screen/login_screen.dart';
import 'package:fluuter_test/registration_screen/signup_screen.dart';
                ...
                child: OutlinedButton.icon(
                  onPressed: () {
                    Navigator.of(context).push(
                      MaterialPageRoute(builder: (ctx) => const CreateAcc()),
                    );
                  },
